This is literally an extension of my binary heap that keeps track of the list index keys every value has. Items must be hashable and unique ot it all breaks.
